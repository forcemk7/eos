...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 motion-reduce:!animate-none motion-reduce:!duration-0",
      className
    )}
    {...props}
    ref={ref}
...
function SheetManualScrim({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "fixed inset-0 z-50 bg-black/80 animate-in fade-in-0 duration-300 motion-reduce:!animate-none motion-reduce:!duration-0",
        className
      )}
      aria-hidden
    />
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 motion-reduce:!animate-none motion-reduce:!transition-none motion-reduce:!duration-0",
  {
    variants: {
      side: {
